...
export default function SafetyData() {
  ...
  return (
    ...
    <div className={styles.layout}>
      ...
      <p className={styles.text}>The colors on this map represent accident density in each section of Melbourne from 2012 to 2023, ranging from dark green(low-risk area) to red(high-risk area).</p>
